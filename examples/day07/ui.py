...
from versioning import FIELDS, effective, fingerprint, matching_template
...
def write_review(path: Path, base: dict, candidate: dict, plan: dict, before: Path, after: Path):
    data = {'base':base,'candidate':candidate,'plan':plan,'labels':LABELS,'plan_sha256':fingerprint(plan)}
